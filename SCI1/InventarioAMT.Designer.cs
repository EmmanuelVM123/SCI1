...
namespace SCI1
{
    partial class InventarioAMT
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.inventario11111TableAdapter = new SCI1.SCIDataSetTableAdapters.Inventario11111TableAdapter();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.inventario11111BindingSource)).BeginInit();
            ...
            // descripcionTextBox
            // 
            this.descripcionTextBox.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.inventario11111BindingSource, "Descripcion", true));
            ...
            // 
            this.cantidadCriticaNumericUpDown.DataBindings.Add(new System.Windows.Forms.Binding("Value", this.inventario11111BindingSource, "CantidadCritica", true));
            ...
            // 
            this.cantidadNormalNumericUpDown.DataBindings.Add(new System.Windows.Forms.Binding("Value", this.inventario11111BindingSource, "CantidadNormal", true));
            ...
            // 
            this.nombreArticuloTextBox.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.inventario11111BindingSource, "NombreArticulo", true));
            ...
            // idArticuloTextBox
            // 
            this.idArticuloTextBox.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.inventario11111BindingSource, "IdArticulo", true));
            ...
            this.inventarioDataGridView.DataSource = this.inventario11111BindingSource;
            ...
            // 
            // inventario11111TableAdapter
            // 
            this.inventario11111TableAdapter.ClearBeforeFill = true;
            // 
            // tableAdapterManager
            // 
            ...
            ((System.ComponentModel.ISupportInitialize)(this.inventario11111BindingSource)).EndInit();
